...
\makeatother
    ...
    \subsection{Study of TUC policy for a simple
network}\label{study-of-tuc-policy-for-a-simple-network}
...
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} INITIALIZING NETWORK}
        ...
        \PY{k}{def} \PY{n+nf}{compute\PYZus{}X\PYZus{}G}\PY{p}{(}\PY{n}{Tu0}\PY{p}{,}\PY{n}{Tu}\PY{p}{,}\PY{n}{C}\PY{p}{,}\PY{n}{S}\PY{p}{,}\PY{n}{L}\PY{p}{,}\PY{n}{T}\PY{p}{,}\PY{n}{j}\PY{p}{,}\PY{n}{o}\PY{p}{,}\PY{n}{time\PYZus{}var}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}\PY{p}{:}
            ...
            \PY{c+c1}{\PYZsh{} Defininf links and junction interactions }
            \PY{k}{for} \PY{n}{junction} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{j}\PY{p}{)}\PY{p}{:}
                \PY{n}{A1}\PY{p}{[}\PY{n}{junction}\PY{p}{]} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{Tu0}\PY{p}{[}\PY{n}{junction}\PY{p}{]}\PY{p}{)} \PY{o}{*} \PY{p}{(}\PY{n}{Tu}\PY{p}{[}\PY{n}{junction}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{*} \PY{n}{S}\PY{p}{[}\PY{n}{junction}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{/} \PY{n}{C}\PY{p}{[}\PY{n}{junction}\PY{p}{]}\PY{p}{)}
                \PY{n}{A2}\PY{p}{[}\PY{n}{junction}\PY{p}{]} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{Tu0}\PY{p}{[}\PY{n}{junction}\PY{p}{]}\PY{p}{)} \PY{o}{*} \PY{p}{(}\PY{n}{Tu}\PY{p}{[}\PY{n}{junction}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{*} \PY{n}{S}\PY{p}{[}\PY{n}{junction}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{/} \PY{n}{C}\PY{p}{[}\PY{n}{junction}\PY{p}{]}\PY{p}{)}
            ...
            \PY{c+c1}{\PYZsh{} Definin feasible green times boundaries}
            \PY{n}{bounds} \PY{o}{=} \PY{p}{(}\PY{p}{(}\PY{l+m+mi}{15}\PY{p}{,}\PY{l+m+mi}{85}\PY{p}{)}\PY{p}{,}\PY{p}{(}\PY{l+m+mi}{15}\PY{p}{,}\PY{l+m+mi}{85}\PY{p}{)}\PY{p}{,}\PY{p}{(}\PY{l+m+mi}{15}\PY{p}{,}\PY{l+m+mi}{85}\PY{p}{)}\PY{p}{,}\PY{p}{(}\PY{l+m+mi}{15}\PY{p}{,}\PY{l+m+mi}{85}\PY{p}{)}\PY{p}{,}\PY{p}{(}\PY{l+m+mi}{70}\PY{p}{,}\PY{l+m+mi}{90}\PY{p}{)}\PY{p}{)} \PY{k}{if} \PY{n}{time\PYZus{}var} \PY{k}{else} \PY{p}{(}\PY{p}{(}\PY{l+m+mi}{50}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{)}\PY{p}{,}\PY{p}{(}\PY{l+m+mi}{50}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{)}\PY{p}{,}\PY{p}{(}\PY{l+m+mi}{50}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{)}\PY{p}{,}\PY{p}{(}\PY{l+m+mi}{50}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{)}\PY{p}{,}\PY{p}{(}\PY{l+m+mi}{70}\PY{p}{,}\PY{l+m+mi}{70}\PY{p}{)}\PY{p}{)}
        
            \PY{c+c1}{\PYZsh{} Constraint to make sure that all signals in a link stay within the cycle defined time.}
            \PY{n}{linear\PYZus{}constraint} \PY{o}{=} \PY{p}{(}\PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{eq}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{fun}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{k}{lambda} \PY{n}{x}\PY{p}{:}  \PY{n}{x}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{+} \PY{n}{x}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{+} \PY{n}{L}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{n}{C}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{\PYZcb{}}\PY{p}{,} \PY{c+c1}{\PYZsh{} Link 1}
                                 \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{eq}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{fun}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n}{x}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]} \PY{o}{+} \PY{n}{x}\PY{p}{[}\PY{l+m+mi}{3}\PY{p}{]} \PY{o}{+} \PY{n}{L}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{n}{C}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{\PYZcb{}}\PY{p}{)} \PY{c+c1}{\PYZsh{} Link 2}
            ...
            \PY{c+c1}{\PYZsh{} Minimization problem to find feasible gs as close as possible to the optimal gs found by riccati eq}
            \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{100}\PY{p}{)}\PY{p}{:}
                ...
                \PY{n}{min\PYZus{}f} \PY{o}{=} \PY{n}{minimize}\PY{p}{(}\PY{n}{greens}\PY{p}{,} \PY{c+c1}{\PYZsh{} function to be minimized}
                                 ...
                                 \PY{n}{method}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{SLSQP}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{c+c1}{\PYZsh{} Sequential Least SQuares Profact\PYZus{}gramminfact\PYZus{}g method for minimizinfact\PYZus{}g}
        ...
        \PY{k}{def} \PY{n+nf}{make\PYZus{}plots}\PY{p}{(}\PY{n}{X}\PY{p}{,}\PY{n}{G}\PY{p}{,}\PY{n}{params}\PY{p}{,}\PY{n}{perturbations}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{k} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{linspace}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{100}\PY{p}{,}\PY{n}{num}\PY{o}{=}\PY{l+m+mi}{100}\PY{p}{)}
            \PY{n}{colors\PYZus{}links} \PY{o}{=} \PY{p}{[}\PY{n}{sns}\PY{o}{.}\PY{n}{xkcd\PYZus{}rgb}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{dark yellow}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}\PY{n}{sns}\PY{o}{.}\PY{n}{xkcd\PYZus{}rgb}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{sea blue}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}\PY{n}{sns}\PY{o}{.}\PY{n}{xkcd\PYZus{}rgb}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{scarlet}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{]}
            \PY{n}{colors\PYZus{}lights} \PY{o}{=} \PY{p}{[}\PY{n}{sns}\PY{o}{.}\PY{n}{xkcd\PYZus{}rgb}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{sand}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}\PY{n}{sns}\PY{o}{.}\PY{n}{xkcd\PYZus{}rgb}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{pale yellow}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}\PY{n}{sns}\PY{o}{.}\PY{n}{xkcd\PYZus{}rgb}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{sky}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}\PY{n}{sns}\PY{o}{.}\PY{n}{xkcd\PYZus{}rgb}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{ocean blue}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}\PY{n}{sns}\PY{o}{.}\PY{n}{xkcd\PYZus{}rgb}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{salmon pink}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{]}
            ...
            \PY{n}{fig}\PY{o}{.}\PY{n}{suptitle}\PY{p}{(}\PY{n}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{t\PYZus{}AB=}\PY{l+s+si}{\PYZob{}params[0]\PYZcb{}}\PY{l+s+s2}{   S\PYZus{}in=}\PY{l+s+si}{\PYZob{}params[1]\PYZcb{}}\PY{l+s+s2}{    t\PYZus{}out =}\PY{l+s+si}{\PYZob{}params[2]\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{fontsize} \PY{o}{=} \PY{l+m+mi}{15}\PY{p}{)}
            \PY{n}{fig}\PY{o}{.}\PY{n}{savefig}\PY{p}{(}\PY{n}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{t\PYZus{}AB=}\PY{l+s+si}{\PYZob{}params[0]\PYZcb{}}\PY{l+s+s2}{   S\PYZus{}out=}\PY{l+s+si}{\PYZob{}params[1]\PYZcb{}}\PY{l+s+s2}{    t\PYZus{}out =}\PY{l+s+si}{\PYZob{}params[2]\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{bbox\PYZus{}inches}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tight}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n+nb}{format}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        ...
        \PY{k}{def} \PY{n+nf}{make\PYZus{}plots2}\PY{p}{(}\PY{n}{X1}\PY{p}{,}\PY{n}{X2}\PY{p}{,}\PY{n}{params}\PY{p}{,}\PY{n}{perturbations}\PY{p}{)}\PY{p}{:}
            ...
            \PY{c+c1}{\PYZsh{}fig.suptitle(f\PYZdq{}t\PYZus{}AB=\PYZob{}params[0]\PYZcb{}   S\PYZus{}in=\PYZob{}params[1]\PYZcb{}    t\PYZus{}out =\PYZob{}params[2]\PYZcb{}\PYZdq{},fontsize = 15)}
            \PY{n}{fig}\PY{o}{.}\PY{n}{savefig}\PY{p}{(}\PY{n}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{t\PYZus{}AB=}\PY{l+s+si}{\PYZob{}params[0]\PYZcb{}}\PY{l+s+s2}{\PYZhy{}S\PYZus{}out=}\PY{l+s+si}{\PYZob{}params[1]\PYZcb{}}\PY{l+s+s2}{\PYZhy{}t\PYZus{}out =}\PY{l+s+si}{\PYZob{}params[2]\PYZcb{}}\PY{l+s+s2}{\PYZus{}var\PYZus{}not\PYZus{}var}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{bbox\PYZus{}inches}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tight}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n+nb}{format}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
